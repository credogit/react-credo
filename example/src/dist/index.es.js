...
var CredoContext = createContext({
    config: {},
...
var CredoConsumerChild = function (_a) {
    ...
    var _b = useContext(CredoContext), config = _b.config, initializePayment = _b.initializePayment, onSuccess = _b.onSuccess, onClose = _b.onClose;
...
var CredoConsumer = forwardRef(function (_a, ref) {
...
export { CredoButton, CredoConsumer, useCredoPayment };
